...
- (void) setStitches:(NSBezierPath*) stitches {
	[stitches retain];
	[_stitches release];
	_stitches = stitches;
}
...
- (void) drawWithSelection:(BOOL) selected {
	...
	NSColor* color = [NSColor colorWithCalibratedRed:_r/255 green:_g/255 blue:_b/255 alpha: 1.0f];
